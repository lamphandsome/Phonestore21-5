...
public class MomoApi {
    ...
    public ResponsePayment getUrlPayment(@RequestBody PaymentDto paymentDto){
        ...
        try {
            captureATMMoMoResponse = CreateOrderMoMo.process(environment, orderId, requestId, Long.toString(td), "Aptech Mobile", paymentDto.getReturnUrl(), paymentDto.getNotifyUrl(), "", RequestType.PAY_WITH_ATM, null);
        } catch (Exception e) {
            e.printStackTrace();
        }
